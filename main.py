...
async def on_message(message):
    ...
    if not responded and "привітик" in content:
        await message.reply("Хто це у нас тут у сердечках купається <@880913891654254603>))")
        responded = True
    ...
    if not responded and content == "правило 1":
        await message.reply("🧭 1. **Головна сторона**/n/n 1.1 Усі важливі рішення приймає **"Аня" та "Цукерка".**")
        responded = True
